...
public class Ejecutivo extends Persona {
	...
	// CONSTRUCTOR
	public Ejecutivo(String rut, String idCompania, String nombre1, String nombre2, String apellido1,
	...
	/////////////////////////// * METODOS * /////////////////////////////////////////////
		...
		documento.add(new Paragraph("\nDatos del Ejecutivo:                        " + getNombre1() + " " + nombre2
				+ " " + getApellido1() + " " + apellido2));
		documento.add(new Paragraph("\nRut: " + getRut() + ", Email: " + email));
		documento.add(new Paragraph("\nTel�fono: " + fonoFijo + ", Celular: " + fonoCel));
