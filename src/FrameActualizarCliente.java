...
public class FrameActualizarCliente extends JFrame {
	...
	public FrameActualizarCliente(Compania datosEmpresa) {
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (datosEmpresa.buscarCliente(textFieldRut.getText())!=null){	// SI CLIENTE EXISTE
					...
					// CONVIERTE EN EDITABLES LOS JTextField Movil, Fono, Direccion, Email y textFieldRut COMO NO EDITABLE
		...
		panel_2.setBorder(new TitledBorder(null, "Atributos personales", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		panel.add(panel_2);
