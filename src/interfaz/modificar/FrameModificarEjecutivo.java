...
public class FrameModificarEjecutivo extends JFrame {
	...
	public static void main(String[] args, Compania datosEmpresa) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					FrameModificarEjecutivo frame = new FrameModificarEjecutivo(datosEmpresa);
	 ...
	 * Create the frame.
	 */
	public FrameModificarEjecutivo(Compania datosEmpresa) {
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setTitle("Actualizar datos de un Ejecutivo");
		setResizable(false);
		...
		btnModificar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Ejecutivo a = datosEmpresa.getEjecutivos().buscarEjecutivo(textFieldRut.getText());
		...
		btnBuscar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if (datosEmpresa.getEjecutivos().buscarEjecutivo(textFieldRut.getText()) != null) { 
					// SI CLIENTE EXISTE
					Ejecutivo a = datosEmpresa.getEjecutivos().buscarEjecutivo(textFieldRut.getText());
