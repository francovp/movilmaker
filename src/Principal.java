...
public class Principal {
	...
	public static void obtenerDatos () throws SQLException{
		Database bd = null;
		Compania datos = null; // Aquí se guardará toda la información de la empresa
		
		// Valor para saber qué datos faltan en los datos guardados
		int falta = 0; 
		// 0 = No hay personas, no hay admin ; 1 = Hay personas, NO hay admin ;  2 = Hay personas y hay admin
		// -1 = hay todo
		//... continuará..
					...
					if (datos != null){
						...
						if (datos != null){
							...
							if (datos != null){
								...
								// Mientras no se hace nada mientras no se agregue una interfaz para crear Equipos
							}
						}else{
							System.err.println("No hay datos de planes");
							// Por ahora aquí no se hace nada
							// Mientras no se hace nada mientras no se agregue una interfaz para crear Planes
						}
					}else{
